...
<div>
    <br/>
    <form class="mb-mt-10 mt-url-from form-url-pl-360" action="" method="post">
        <div class="form-group">
            <div class="form-group">
                <label for="basic-url">Enter an url</label>
                <div class="mta-input-group">
                    ...
                    <div class="mta-input-group-area"><input type="text" name="url" class="form-control" id="url" aria-describedby="url" placeholder="Enter url..."></div>
